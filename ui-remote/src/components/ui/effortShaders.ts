/**
 * GLSL 着色器源码。移植自 github.com/254558/claude-range-slider，
 * 复刻 Claude Code 官方 effort 滑块的火焰特效。逐字保留，勿改数值。
 *
 * VERT      — 全屏三角形，输出 UV
 * FRAG_SIM  — 火焰模拟：细胞网格、衰减、火花、边缘光
 * FRAG_BLUR — 7-tap 高斯模糊（横/纵复用，u_dir 区分）
 * FRAG_COMP — 场景 + glow 色调映射合成
 */
