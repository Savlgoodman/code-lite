...
def _collect_about_info(services: AppServices) -> dict[str, Any]:
    ...
    app_version = os.environ.get("CODE_LITE_APP_VERSION") or _read_json_version(REPO_ROOT / "package.json")
    if app_version == "待检测":
        app_version = APP_VERSION
    backend_version = os.environ.get("CODE_LITE_BACKEND_VERSION") or _read_pyproject_version(
