...
本目录用于保留 code-lite 早期 Python SDK 能力探针：Codex、Claude Agent SDK 和 nanobot。当前 coding agent 主线已转向 ACP，新的实现与调研入口见 `docs/README.md` 和 `docs/design/0703-AGENT-ACP-IMPLEMENTATION.md`。
